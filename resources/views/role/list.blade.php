...
<body>
    ...
    <table id="dt-multi-checkbox" class="table" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <td>
            <a href="{{ url('/roles/edit/' . $row->id) }}" class="btn btn-primary">Edit</a>
            {{ Form::open(['method'=>'DELETE','url'=>['/roles/delete/'.$row->id],'style'=>'display:inline' ]) }}
